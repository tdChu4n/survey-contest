  ...
  return (
    <header className="nav contest-admin-nav">
      ...
      <div className="nav__user">
        <div className="nav__avatar">QT</div>
        <div>
          <div className="nav__user-name">Hội đồng quản trị dữ liệu</div>
          <div className="nav__user-mail">contact@example.edu.vn</div>
        </div>
      </div>
      <button
        onClick={() => { sessionStorage.removeItem('adminLoggedIn'); window.location.replace('index.html'); }}
        style={{
